import HomeImage from "../../src/assets/PublicDashboardLogos/HomeImage.svg";
import LinkedinLogo from "../../src/assets/PublicDashboardLogos/LinkedInLogo.svg"
import FacebookLogo from "../../src/assets/PublicDashboardLogos/FacebookLogo.svg"
import TwitterLogo from "../../src/assets/PublicDashboardLogos/TwitterLogo.svg"
function PublicFooter({hideImage} : {hideImage  ?: boolean}) {
  return (
    <div>
     {!hideImage && <div className="w-full flex justify-center px-[60px]">
        <div className="flex items-center justify-center mt-[200px]">
          <img src={HomeImage} alt="" className="2xl:w-[1318px] h-[670px]" />
        </div>
      </div>}
